<p align="center">
  <img src="com.ssheppdev.litra.sdPlugin/imgs/plugin/marketplace@2x.png" alt="Litra for Stream Deck" width="168" />
</p>

<h1 align="center">Litra for Stream Deck</h1>

<p align="center">
  <strong>Warm key-light control</strong> for Logitech Litra — from an Elgato Stream Deck,<br />
  including dials on Stream Deck+.
</p>

<p align="center">
  <a href="https://github.com/SSheppDev/streamdeck-litra/releases/latest"><img src="https://img.shields.io/github/v/release/SSheppDev/streamdeck-litra?style=for-the-badge&color=FFB347&labelColor=1A1A1A" alt="Latest release" /></a>
  <a href="LICENSE"><img src="https://img.shields.io/badge/license-MIT-7EC8FF?style=for-the-badge&labelColor=1A1A1A" alt="MIT License" /></a>
  <img src="https://img.shields.io/badge/Stream%20Deck-7.1%2B-F5C542?style=for-the-badge&labelColor=1A1A1A" alt="Stream Deck 7.1+" />
  <img src="https://img.shields.io/badge/macOS%20%7C%20Windows-USB-E8E8E8?style=for-the-badge&labelColor=1A1A1A" alt="macOS and Windows over USB" />
</p>

<p align="center"><em>Not an official Logitech or Elgato product.</em></p>
...
<p align="center">
  <img src="com.ssheppdev.litra.sdPlugin/imgs/actions/power/key-on@2x.png" width="88" alt="Power on" />
  &nbsp;&nbsp;
  <img src="com.ssheppdev.litra.sdPlugin/imgs/actions/power/key-off@2x.png" width="88" alt="Power off" />
  &nbsp;&nbsp;
  <img src="com.ssheppdev.litra.sdPlugin/imgs/actions/brightness/key@2x.png" width="88" alt="Brightness" />
  &nbsp;&nbsp;
  <img src="com.ssheppdev.litra.sdPlugin/imgs/actions/temperature/key@2x.png" width="88" alt="Temperature" />
</p>

<p align="center">
  <sub>Power · Brightness · Temperature</sub>
</p>

| | Action | Key | Dial (Stream Deck+) |
| :---: | :--- | :--- | :--- |
| <img src="com.ssheppdev.litra.sdPlugin/imgs/actions/power/icon@2x.png" width="28" alt="" /> | **Power** | On / off / toggle | — |
| <img src="com.ssheppdev.litra.sdPlugin/imgs/actions/brightness/icon@2x.png" width="28" alt="" /> | **Brightness** | Jump to a preset % | Rotate to adjust; **press toggles power** |
| <img src="com.ssheppdev.litra.sdPlugin/imgs/actions/temperature/icon@2x.png" width="28" alt="" /> | **Temperature** | Jump to a preset Kelvin | Rotate to adjust; **press toggles power** |
